...
// router.use('/dist', express.static(path.join(__dirname, '../dist'), options));
...
const data = [
  require(path.resolve(__dirname, '../data/game1.json')),
  require(path.resolve(__dirname, '../data/game2.json')),
  require(path.resolve(__dirname, '../data/game3.json'))
];
