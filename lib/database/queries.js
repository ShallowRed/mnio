...
module.exports = {
  ...
  createPalettesTable: "CREATE TABLE game_?__palettes (playerid SMALLINT PRIMARY KEY NOT NULL, paletteid SMALLINT NOT NULL)",
  ...
  savePalette: "INSERT INTO game_?__palettes (`playerid`, `paletteid`) VALUES(?, ?)",
