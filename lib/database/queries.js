...
module.exports = {
  ...
  createPokedex: "CREATE TABLE IF NOT EXISTS game_?__pokedex (paletteid INT PRIMARY KEY NOT NULL AUTO_INCREMENT," + colorex + ")",
  fillPokedex: "INSERT INTO game_?__pokedex (" + dexColors + ") VALUES(" + dexValues +")",
