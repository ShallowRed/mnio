...
module.exports = (app, io) => {
  ...
  io.use(function(socket, next) {
    ...
    // Express cookieParser(req, res, next) is used
    // initialy to parse data in "req.headers.cookie".
    // Here our cookies are stored in "request.headers.cookie",
    // so we just pass "request" to the first argument of function
