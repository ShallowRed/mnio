...
io.on('connection', socket => {
  ...
  socket.on('disconnect', () => {
    ...
    Database.save.player(MNIO.PLAYERS[socket.id].dbid, MNIO.PLAYERS[socket.id].colors);
  ...
  socket.on("selectPalette", index => MNIO.PLAYERS[socket.id].colors = pokedex[index]);
