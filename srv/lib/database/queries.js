...
module.exports = {
  createGamesTableIfNotExist: "CREATE TABLE IF NOT EXISTS games (gameid INT PRIMARY KEY NOT NULL AUTO_INCREMENT, usedrows SMALLINT NOT NULL, usedcols SMALLINT NOT NULL, gridid INT NOT NULL, flag BOOLEAN)",
  ...
  createPokedex: "CREATE TABLE IF NOT EXISTS game_?__pokedex (paletteid INT PRIMARY KEY NOT NULL AUTO_INCREMENT," + colorColumns + ")",
  fillPokedex: "INSERT INTO game_?__pokedex (" + colorKeys + ") VALUES(" + colorValues + ")",
