...
module.exports = {
	...
	createPokedex: "CREATE TABLE IF NOT EXISTS pokedex_i (paletteid INT PRIMARY KEY NOT NULL AUTO_INCREMENT," + colorColumns + ")",
	fillPokedex: "INSERT INTO pokedex_i (" + colorKeys + ") VALUES(" + colorValues + ")",
	...
	getEveryPalettes: "SELECT * FROM pokedex_i",
